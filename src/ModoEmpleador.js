...
class ModoEmpleador extends React.Component {
  render() {
    var trabajos = "";
    if (1 === 1) {
      trabajos = <div class="sinTrabajos">
        No se han encontrado trabajos.
    </div>
    } else {
      trabajos = <div class='library'>
    ...
    return (
      <main class='grid'>
        <div class='progress-bar'>
          ...
          <div class="push-right"><AgregarTrabajo/></div>
        </div>
        <div class='track'>
          <div class='top'>
            <p id="temporales-titulo" class='ux'>Trabajos Temporales - Pendientes</p>
          </div>
          {trabajos}
        </div>
      </main>
